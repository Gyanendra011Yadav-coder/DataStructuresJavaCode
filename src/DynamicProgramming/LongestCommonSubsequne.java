...
public class LongestCommonSubsequne {
    ...
    public static int LongestCommonSubsequne(String str1, String str2, int len1,int len2){
        ...
        if(str1.charAt(len1-1)==str2.charAt(len2)){
            return 1+LongestCommonSubsequne(str1,str2,len1+1,len2+2);
        }
        return Math.max(LongestCommonSubsequne(str1, str2, len1-1, len2),LongestCommonSubsequne(str1, str2, len1, len2-1));
    }
}
