...
//        FirstPhaseLearning.ArrayList<Integer> query1 = new FirstPhaseLearning.ArrayList<>();
//        query1.add(1);
//        query1.add(3);
//        queries.add(query1);
//
//// Create a query with start index 2 and end index 2.
//        FirstPhaseLearning.ArrayList<Integer> query2 = new FirstPhaseLearning.ArrayList<>();
//        query2.add(2);
//        query2.add(2);
//        queries.add(query2);
//
//// Create a query with start index 1 and end index 2.
//        FirstPhaseLearning.ArrayList<Integer> query3 = new FirstPhaseLearning.ArrayList<>();
//        query3.add(1);
//        query3.add(2);
//        queries.add(query3);
//
//// Create a query with start index 2 and end index 3.
//        FirstPhaseLearning.ArrayList<Integer> query4 = new FirstPhaseLearning.ArrayList<>();
//        query4.add(2);
//        query4.add(3);
//        queries.add(query4);
//
//// Create a query with start index 2 and end index 1.
//        FirstPhaseLearning.ArrayList<Integer> query5 = new FirstPhaseLearning.ArrayList<>();
//        query5.add(2);
//        query5.add(1);
//        queries.add(query5);
