...
//        FirstPhaseLearning.ArrayList<FirstPhaseLearning.ArrayList<Integer>> finalResult=findTriplets2(arrayList, arrayList.size(),4);
//        for(FirstPhaseLearning.ArrayList arrayList1 : finalResult){
...
//        }
        ...
        int [] arr={1 ,2 ,3 ,1 ,2 ,3};
//        FirstPhaseLearning.ArrayList<Integer> list=findTriplets(arr,arr.length,12);
//        for(int val:list){
//            System.out.println(val+" ");
//        }

//        FirstPhaseLearning.ArrayList<FirstPhaseLearning.ArrayList<Integer>> finalResult=findTriplets2(arr,arr.length,6);
//        for(FirstPhaseLearning.ArrayList arrayList1 : finalResult){
//            for (int i=0;i<arrayList1.size();i++){
//                System.out.print(arrayList1.get(i)+" ");
//            }
