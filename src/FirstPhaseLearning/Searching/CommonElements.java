...
//    public static FirstPhaseLearning.ArrayList<Integer> commonElements(int A[], int B[], int C[], int n1, int n2, int n3)
//    {
//        FirstPhaseLearning.ArrayList<Integer> duplicates = new FirstPhaseLearning.ArrayList<Integer>(); // will be using this to store the duplicate values in the arrays
