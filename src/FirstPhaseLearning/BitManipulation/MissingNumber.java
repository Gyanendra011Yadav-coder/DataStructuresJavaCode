package FirstPhaseLearning.BitManipulation;
 ...
 *
 * NOTE: Don't use FirstPhaseLearning.Sorting
 */
public class MissingNumber {

    public static void main(String[] args) {
        int []arrayToFindMissingNUmber={2,5,3,1};
        System.out.println(missingNumber(arrayToFindMissingNUmber, arrayToFindMissingNUmber.length));
    }
