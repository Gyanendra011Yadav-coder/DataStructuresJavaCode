package FirstPhaseLearning.LearningJava8.practiceInterviewQuestions;
...
//        list.stream().forEach(System.out::print);
        ...
        System.out.println("FirstPhaseLearning.Sorting all the values present in list in descending order using Stream functions?");
